        ...
        <div class="settings-category-content">
          ...
          <form id="editorAiSettingsForm" class="field" style="display:flex; flex-direction:column; gap:8px;" onsubmit="return false;">
            ...
            <div id="aiKeyOpenaiRow" style="display:none;">
              ...
              <div class="prop-label" style="font-size: 10px; margin-top: 6px;">Custom Base URL <small style="opacity:0.6">(optional)</small></div>
              <input type="text" id="aiBaseUrlOpenai" class="prop-input" placeholder="https://api.openai.com/v1" autocomplete="off" />
              <div style="font-size:9px; opacity:0.6; margin-top:2px;">Override the OpenAI endpoint. Useful for Azure OpenAI, Ollama, LM Studio, vLLM, or any OpenAI-compatible API. <code>/chat/completions</code> is appended automatically.</div>
            </div>
...
Do you want to overwrite it?`)&&await t.importLayout(e,!0);return}throw new Error(o.error||`Import failed: ${i.status}`)}t.setStatus(`Imported: ${o.name||o.id}`,"success"),await t.loadLayouts()}catch(i){b.error("[LayoutManager] Error importing layout:",i),t.setStatus("Failed to import layout","error")}}export{$s as $,p as A,Os as B,ht as C,G as D,P as E,As as F,Xe as G,Ds as H,q as I,Wn as J,pi as K,b as L,li as M,F as N,$ as O,z as P,bt as Q,Hs as R,xt as S,Ws as T,qn as U,Ns as V,Bs as W,Rs as X,$a as Y,zs as Z,Fs as _,xn as a,ks as a0,Ls as a1,Ts as a2,Qs as a3,Ms as a4,K as a5,Is as a6,Gs as a7,is as a8,Us as a9,Ys as aa,Vs as ab,js as ac,L as ad,U as ae,qr as af,Ct as ag,qt as ah,Jn as ai,Ks as aj,Es as ak,Cs as al,Xs as am,Js as an,qs as ao,qa as ap,Ps as aq,tl as b,H as c,Z as d,k as e,ol as f,sl as g,W as h,xe as i,ps as j,ll as k,Ae as l,dl as m,cl as n,N as o,el as p,ms as q,nl as r,O as s,rl as t,Zs as u,al as v,il as w,pl as x,ul as y,hl as z};
